...
function TableViewvaccine() {
    ...
    const handlevaccine = (id) => {
        navigate(`/viewvaccine/${id}`)
    }
                            ...
                            <div class="table-responsive">
                                <table class="table project-list-table table-nowrap align-middle table-borderless">
                                    ...
                                    <div class="form-check font-size-16"><input type="checkbox" class="form-check-input" id="contacusercheck1" /><label class="form-check-label" for="contacusercheck1"></label></div>
                                                ...
                                                <td><span class="badge badge-soft-success mb-0"><button class="badge badge-soft-success mb-0" onClick={() => handlevaccine(data?.appoint_id?._id)}>vaccine</button></span>
                                                </td>
...
export default TableViewvaccine
