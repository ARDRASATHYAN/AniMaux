...
import AddVaccinationcertificate from '../../../components/doctors/vaccinationcertificate/AddVaccinationcertificate'
...
function AddVaccinationcertificates() {
  ...
  return (
    ...
    <div id="wrapper" className={`wrapper-content ${isToggled ? 'toggled' : ''}`}>
      <div id="sidebar-wrapper">
        ...
        <li> <Link className='nav-link ' as={Link} to="/doctoruserview">users</Link></li><hr style={{color:'#fff'}}/>
...
export default AddVaccinationcertificates
